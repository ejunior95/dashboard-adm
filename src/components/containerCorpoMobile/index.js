...
import TimerRegressivoMobile from '@/components/timerRegressivoMobile';
            ...
            isLoading ?
               ...
               : <>
                  <div className="ContainerInfoAtualizacao">
                     ...
                     <TimerRegressivoMobile milissegundos={process.env.REACT_APP_MILISSECONDS_REFRESH} recarregarDados={recarregarDados} />
                  </div>               
                  ...
                  <span className= "TituloGrafico"><strong>Lacres gerados</strong></span>
                     ...
                     <div className="ContainerBarras">
                        {dataBarras.length > 0 && <GraficoBarras data={dataBarras} width={windowWidth} height={windowHeight * 0.4} />}
                     </div>
                  ...
                  <span className= "TituloGrafico"><strong>Separação de produtos</strong></span>
                     ...
                     <div className="ContainerPizza">
                        {dataPizza.length > 0 && <GraficoPizza data={dataPizza} width={windowWidth} height={windowHeight * 0.5} radius={windowHeight / 6} />}
                        ...
                        <div className="ContainerPizzaLegenda">
                           ...
                           <div className="ItemLegenda2">
                              ...
                              <span className="DescLegenda2">Faltantes ({dataPizza[1]?.value || 'carregando...'})</span>
                           </div>
